...
import {
  withStyles, StylesProvider, makeStyles,
            ...
            <form onSubmit={(event) => event.preventDefault()}>
              ...
              <DialogContent dividers style={{ padding: '20px' }}>
                ...
                <Box display="flex" flexDirection="row">
                  <img src={logo} alt="" className={classes.companyLogo} />
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Box display="flex" flexDirection="row">
                    ...
                    <Box py={1} width={1 / 3} display="flex" justifyContent="flex-end">
                      {events
                        ? (
                          <Grow in={events} timeout={500}>
                            <Button
                              ...
                              color="secondary"
                              style={{ marginLeft: '10px', color: !events ? 'rgba(0,0,0,0.2)' : 'white' }}
                              disabled={!events}
                            >
                ...
                <Box display="flex" flexDirection="column" pt={2}>
                  ...
                  <Box display="flex" flexDirection="row" justifyContent="space-between">
                    <Box flexGrow={1} mr={1}>
                      <FormControl className="links-inputfield" fullWidth>
                        <InputLabel>
                          Resume
                        </InputLabel>
                        <Input
